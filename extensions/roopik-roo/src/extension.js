...
export async function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("roodio.ChatPanel", chatPanelProvider, {
        webviewOptions: { retainContextWhenHidden: true },
    }));
    // Register command to open chat panel with optional context
    context.subscriptions.push(vscode.commands.registerCommand("roodio.openChatPanel", async (options) => {
