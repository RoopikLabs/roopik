...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .dio/rules-code/AGENTS.md (relative to project root)
       - .dio/rules-debug/AGENTS.md (relative to project root)
       - .dio/rules-ask/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .dio/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .dio folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    ├── .dio/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .dio/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .dio/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .dio/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .dio/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
