    ...
    function: {
        ...
        parameters: {
            ...
            properties: {
                url: {
                    type: "string",
                    description: "The URL to navigate to (e.g., http://localhost:5173/login or just /login for relative paths)",
                },
            },
            required: ["url"],
            additionalProperties: false,
...
export const browser_action_input = {
    type: "function",
    function: {
...
export const browser_execute_script = {
    type: "function",
    function: {
...
export const browser_inspect_element = {
    type: "function",
    function: {
        ...
        parameters: {
            ...
            properties: {
                selector: {
                    type: "string",
                    description: 'CSS selector to find the element (e.g., ".btn-primary", "#header", "[data-testid=\'submit\']")',
                },
                includeInherited: {
                    type: "boolean",
...
export const browser_get_errors = {
    type: "function",
    function: {
...
export const browser_get_console_logs = {
    type: "function",
    function: {
...
export const browser_get_performance = {
    type: "function",
    function: {
...
export const browser_get_state = {
    type: "function",
    function: {
        name: "browser_get_state",
        description: "[Roopik IDE] Get browser state information (open/closed, current URL, title).",
        strict: true,
        parameters: {
            type: "object",
            properties: {},
...
export const browser_set_viewport = {
    type: "function",
    function: {
        name: "browser_set_viewport",
        description: "[Roopik IDE] Set or clear browser viewport override. Provide width/height to set a specific size (e.g., mobile 375x812). Call with NO parameters to clear override and restore natural browser size.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
...
export const browser_get_network_requests = {
    type: "function",
    function: {
        name: "browser_get_network_requests",
        description: "[Roopik IDE] Get network requests. Use includeStaticAssets parameter to show all assets.",
        strict: false,
        parameters: {
            type: "object",
            properties: {
...
// Project Tools (3)
// ============================================================================
export const project_get_active = {
    type: "function",
    function: {
...
export const canvas_get_active = {
    type: "function",
    function: {
...
export const canvas_open = {
    type: "function",
    function: {
        name: "canvas_open",
        description: "[Roopik IDE] Open an existing canvas by ID or name. Opens the canvas panel in the UI and returns canvas info with all components (id, name, path, status).",
        strict: true,
        parameters: {
            type: "object",
            properties: {
    ...
    function: {
        ...
        parameters: {
            ...
            properties: {
                ...
                framework: {
                    type: "string",
                    description: "Force framework: react, vue, svelte, vanilla. Auto-detected in IDE if not specified.",
...
export const component_add_batch = {
    type: "function",
    function: {
        ...
        parameters: {
            ...
            properties: {
                components: {
                    type: "array",
                    description: "Array of component objects, each with: folderPath (required, absolute or relative to workspace), canvasId, name, entryFile, framework (all optional)",
                    items: {
                        type: "object",
                        properties: {
...
export const component_remove = {
    type: "function",
    function: {
        name: "component_remove",
        description: "[Roopik IDE] Remove component from canvas. Set deleteSourceCode=true to automatically delete source files - do NOT use terminal commands to delete files manually.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
...
export const component_get_info = {
    type: "function",
    function: {
...
export const component_rebuild = {
    type: "function",
    function: {
...
export const canvas_validate_components = {
    type: "function",
    function: {
        name: "canvas_validate_components",
        description: "[Roopik IDE] Validate all components in a canvas in a single efficient call. **IMPORTANT: Use this tool immediately after calling `component_add_batch` or when adding multiple components sequentially to verify their build and runtime health.** Returns a summary (total, success, failed, building counts) plus detailed error information for any failed components, including syntax errors and runtime failures. This is significantly more efficient than polling individual `component_get_info` calls. Use this to catch errors early and ensure users see a working UI.",
        strict: true,
        parameters: {
            type: "object",
            properties: {
...
// ============================================================================
export const roopikNativeTools = [
    // Browser (14 tools)
    browser_open,
    browser_close,
...
//# sourceMappingURL=roopik.js.map