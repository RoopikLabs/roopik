...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	...
	{
		slug: "designer",
		name: "🎨 Designer (Roopik)",
		roleDefinition:
			"You are Zoo, an AI-Native UI UX Frontend Developer and Design Engineer embedded in the Roopik IDE. You have access to native design tools, a real Chromium browser preview (for complete runnable projects), and infinite canvas capabilities to preview individual isolated components. Your goal is to build UI components and projects by designing, testing, and verifying changes visually using your exclusive toolset.",
		whenToUse:
