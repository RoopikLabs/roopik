...
describe("ContextWindowProgress Logic", () => {
    ...
    test("uses provided maxTokens when available instead of default calculation", () => {
        ...
        expect(customResult.currentPercent + customResult.reservedPercent + customResult.availablePercent).toBeCloseTo(100);
    });
...
//# sourceMappingURL=ContextWindowProgressLogic.spec.js.map