...
import { BEDROCK_1M_CONTEXT_MODEL_IDS, litellmDefaultModelInfo } from "@roo-code/types";
import { useSelectedModel } from "../useSelectedModel";
import { useRouterModels } from "../useRouterModels";
import { useOpenRouterModelProviders } from "../useOpenRouterModelProviders";
vi.mock("../useRouterModels");
vi.mock("../useOpenRouterModelProviders");
const mockUseRouterModels = useRouterModels;
const mockUseOpenRouterModelProviders = useOpenRouterModelProviders;
const createWrapper = () => {
...
//# sourceMappingURL=useSelectedModel.spec.js.map