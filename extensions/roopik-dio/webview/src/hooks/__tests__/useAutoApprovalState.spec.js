...
describe("useAutoApprovalState", () => {
    ...
    describe("memoization", () => {
        it("should not recompute hasEnabledOptions when toggles object reference changes but values are the same", () => {
            ...
            const { result, rerender } = renderHook(({ toggles, autoApprovalEnabled }) => useAutoApprovalState(toggles, autoApprovalEnabled), {
                initialProps: {
    ...
    describe("edge cases", () => {
        ...
        it("should handle mixed truthy/falsy values correctly", () => {
            const toggles = {
                alwaysAllowReadOnly: 1, // truthy non-boolean
                alwaysAllowWrite: "", // falsy non-boolean
                alwaysAllowExecute: null, // falsy non-boolean
                alwaysAllowBrowser: "yes", // truthy non-boolean
            };
            const { result } = renderHook(() => useAutoApprovalState(toggles, true));
...
//# sourceMappingURL=useAutoApprovalState.spec.js.map