...
/**
 * Sample Components for Canvas
 *
 * These are ComponentInput objects ready to be sent to Core's ESBuild pipeline.
 * The pipeline will:
 * 1. Detect framework (React in these cases)
 * 2. Generate synthetic entry point
 * 3. Bundle with ESBuild
 * 4. Resolve dependencies from CDN (esm.sh)
 * 5. Return bundledCode ready for iframe execution
 */
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#666', lineHeight: '1.6' }}>
          This is a sample card component rendered in the Roopik Canvas.
